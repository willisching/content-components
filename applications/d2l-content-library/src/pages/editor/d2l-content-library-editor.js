...
class D2LContentLibraryEditor extends DependencyRequester(PageViewElement) {
	...
	render() {
		...
		return html`
			<div class="d2l-content-library-editor">
...
customElements.define('d2l-content-library-editor', D2LContentLibraryEditor);
